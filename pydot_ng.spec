...
License  : MIT
Requires: pydot_ng-license = %{version}-%{release}
Requires: pydot_ng-python = %{version}-%{release}
Requires: pydot_ng-python3 = %{version}-%{release}
Requires: graphviz
Requires: pyparsing
...
%description license
license components for the pydot_ng package.
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/pydot_ng
cp %{_builddir}/pydot_ng-2.0.0/LICENSE %{buildroot}/usr/share/package-licenses/pydot_ng/e38c1f7359ea268ce9ecd751f3fd9787fb2d40db
...
/usr/share/package-licenses/pydot_ng/e38c1f7359ea268ce9ecd751f3fd9787fb2d40db
